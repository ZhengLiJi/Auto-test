...
class Payout(BaseUtils):
    ...
    def __init__(self,merchantId,productId ,currency,amount , accountNumber ,bankCode,accountHolderName, privateKey):
        self.data = {
            'version': 1.0,
...
if __name__ == '__main__':
    ...
    '''1表示通道回调成功，2表示通道失败'''
    xendit_dana_1 = Payout(100119,2023, "IDR", 10000, '081382826301', 'DANA','user_faspay','97fa79f073c7c5e3c97b00b50b156eaa')
    ...
    resp = xendit_dana_1.post(url = "/pay/payout" , data=xendit_dana_1.data['params'], desc='模拟xendit1付款成功')
    print(resp)
